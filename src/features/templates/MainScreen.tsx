...
   
    // Key Dark Mode additions: dark:bg-..., dark:text-..., dark:hover:bg-..., dark:border-..., dark:focus:ring-...
    const variantStyles = {
...
      <header className="mb-4 rounded-lg p-2 flex flex-col md:flex-row justify-between items-center border-b border-gray-300 gap-4 dark:border-gray-700">
       
...
                        onClick={handleUndo} 
                        disabled={!hasChanges} 
                        className="text-red-600 hover:bg-red-50 transition-opacity dark:text-red-400 dark:hover:bg-red-900/20 dark:hover:border-red-400"
                    >
...
      {/* Confirmation Dialog Components - Assuming ConfirmationDialog supports dark theme internally or needs separate styling */}
      <ConfirmationDialog
