  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
        <h1 className="text-3xl font-bold text-foreground">Packing Unit List</h1>
      ...
      <div className="p-4 bg-background rounded-lg shadow border border-muted">
        <div className="relative">
          <input
            type="text"
            placeholder="Search by ID, Packing Name, Short Name..."
            value={search}
        ...
        <div className="hidden md:block overflow-x-auto">
          <table className="min-w-full divide-y divide-muted">
            ...
            <tbody className="divide-y divide-muted">
              {paginatedData.map((entry: PackingEntry, index) => (
                <tr key={entry.id}>
                  ...
                  <td className="px-6 py-4 text-sm">{entry.shortName}</td>
