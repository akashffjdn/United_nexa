              ...
              {paginatedData.length > 0 ? (
                paginatedData.map((entry, index) => (
                  <tr key={entry.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <span className="font-medium text-foreground">{entry.contentName}</span>
                    </td>
                    <td className="px-4 py-3">
              ...
              {paginatedData.length > 0 ? (
                paginatedData.map((entry, index) => (
                  <tr key={entry.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-3 py-3">
                      <div>
                        <span className="font-medium text-foreground block">{entry.contentName}</span>
              ...
              <div key={entry.id} className="p-4">
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    {/* Header */}
                    <div className="mb-2">
                      <h3 className="font-semibold text-foreground truncate">{entry.contentName}</h3>
