              ...
              {currentToPlaces.length > 0 ? (
                currentToPlaces.map((toPlace, index) => (
                  <tr key={toPlace.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-3 py-3">
                      <div>
                        <span className="font-medium text-foreground block">{toPlace.placeName}</span>
                        <span className="text-xs text-muted-foreground mt-0.5 block">{toPlace.shortName}</span>
                      </div>
                    </td>
                    <td className="px-3 py-3">
                      <div className="flex items-center justify-end gap-1">
